...
#define TESTRUN0(WEIGHT, FNAME, F1, F2, ARGS)\
  FNAME, mptest WEIGHT (ss_pair1 F1 F2 ARGS)
#define TESTRUN(WEIGHT, FNAME, F1, F2, PGM, ARGS)\
  FNAME, mptest WEIGHT (ss_pair2 F1 F2 PGM ARGS)
