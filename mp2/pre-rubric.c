...
#define TEST5ARG_TWOFUN(WEIGHT, FNAME1, FNAME2, ARG1, ARG2, ARG3, ARG4, ARG5)\
    #FNAME1^" "^#ARG1^" "^#ARG2^" "^#ARG3, mptest WEIGHT (ss_pair5 FNAME1 FNAME2 (ARG1) (ARG2) (ARG3) (ARG4) (ARG5))

let rubric_version = "1.0"
let rubric_title = "CS421 Spring 2011 MP2"
